...
export const content = {
  ar: {
    ...
    contactCta: "اتصل بنا",
    hero: {
       badge: "بي بلس للمدفوعات الالكترونية",
       title1: "خدمات متكاملة،",
      title2: "بدقة هندسية.",
       body: "حلول دفع إلكتروني تربط سداد فواتير وشحن كروت مرافق الكهرباء والمياه والغاز بملايين المواطنين عبر نقاط بيع وشبكات الوكلاء المنتشرة في جميع انحاء الجمهورية.",
    ...
    network: {
      ...
      pos: {
        title: "نقاط البيع",
         body: "أجهزة دفع تعمل على مدار الساعة عبر نقاط البيع المنتشرة في كافة انحاء الجمهورية مع تسوية آلية وتكامل مباشر مع أنظمة الفوترة.",
        stats: [
           { value: "200,000+", label: "نقطة بيع نشطة" },
      ...
      app: {
        ...
        title: "دفع من جيبك",
         body: "فواتير فورية وإشعارات ذكية عبر تطبيقات وكلاء  بي بلس على انظمة IOS و Android.",
      },
      agents: {
    ...
    coverage: {
      ...
      title: "مصر بالكامل، على شبكة واحدة",
       body: "من الإسكندرية إلى أسوان، تصل شبكات التحصيل إلى كل محافظة عبر بنية تحتية مملوكة بالكامل.",
      badge: "تغطية 100%",
      alt: "خريطة تغطية بي بلس في مصر",
      stats: [
        { value: "27", label: "محافظة مغطاة", hl: true },
         { value: "2.1B", label: "فاتورة سنوياً", hl: false },
         { value: "200K+", label: "وكيل معتمد", hl: false },
    ...
    features: {
      eyebrow: "قدرات المنصة",
       title: "بنية تحتية متكاملة للتحصيل",
      items: [
        ...
        { k: "AES", t: "أمان البيانات", b: "تشفير عند النقل والتخزين مطابق لمعايير PCI-DSS." },
         { k: "⟂", t: "تقارير لحظية", b: "لوحات تحكم تعمل بشكل لحظي" },
